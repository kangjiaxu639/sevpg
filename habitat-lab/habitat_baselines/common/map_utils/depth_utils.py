...
from habitat_baselines.common.constants import color_palette
import cv2
...
def init_vis_image(legend):
    legend = cv2.imread(legend)
...
def _visualize_map(inputs):

    vis_image = init_vis_image(legend="/home/ros/kjx/sevpg/habitat-lab/docs/legend_gibson.png")
    ...
    no_cat_mask = sem_map == inputs["num_sem_categories"] + 4
    ...
    vis_image[50:530, 15:655] = inputs['rgb_vis']
    vis_image[50:530, 670:1150] = sem_map_vis

    cv2.imshow("Accumulated semantic map", vis_image)
    cv2.waitKey(1)
